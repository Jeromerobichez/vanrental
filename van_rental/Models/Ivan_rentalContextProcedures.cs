...
namespace van_rental.Models
{
    ...
    {
        Task<List<GetAvailablesVehiclesResult>> GetAvailablesVehiclesAsync(DateTime? departureDate, DateTime? returnDate, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
